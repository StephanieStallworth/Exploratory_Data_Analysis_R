...
**Word Cloud**
Once the data is tidyed, a word cloud is created to get a quick loook at the most frequently occuring words in the sampled text, excluding stop words (i.e. the, for, that,etc).
```{r}
library(wordcloud)
tcorpus<-tm_map(words1, removeWords, stopwords("english"))
...
Through this exploratory analysis, I was able to identify the most commonly used words which will be helpful in proceeding to the next steps of the project. 
